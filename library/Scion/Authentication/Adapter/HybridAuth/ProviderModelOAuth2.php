...
*/
use Scion\Authentication\Adapter\HybridAuth\thirdparty\OAuth\OAuth2Client;

/**
 * To implement an OAuth 2 based service provider, Provider_Model_OAuth2
 * can be used to save the hassle of the authentication flow.
 *
 * Each class that inherit from Provider_Model_OAuth2 have to implemenent
 * at least 2 methods:
 ...
 *
 * Provider_Model_OAuth2 use OAuth2Client v0.1 which can be found on
