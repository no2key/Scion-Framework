...
use Scion\Db\Configuration;
use Scion\Db\Pdo;
use Scion\Db\Query\Delete;
use Scion\Db\Query\Insert;
use Scion\Db\Query\Select;
use Scion\Db\Query\Structure;
use Scion\Db\Query\Update;
...
abstract class AbstractProvider {
	 ...
	 * @return Update
	 */
	public function update($table, $set = [], $where = '', $whereParams = '') {
